...
class Rx2SharedPreferencesTest {
    ...
    fun testWithNoValueReturnsDefaultValue() {
        ...
        assertEquals(Point(1, 1), rx2SharedPreferences.getObject("test", Point(1, 1), spy<PointPreferenceConverter>()).value)
    }

    @Test
    fun testObjectNullDefaultValueThrows() {
        assertFailsWith<NullPointerException>("defaultValue == null") { rx2SharedPreferences.getObject("key", null, spy<PointPreferenceConverter>()) }
    }
