...
class Rx2PreferenceTest {
    ...
    fun setNullThrows() {
        ...
        val rx2Pref = Preference(sharedPrefs, "test", "-1", StringAdapter).asRx2Preference(keyChangeSharedObservable)

        assertFailsWith<NullPointerException>("value == null") { rx2Pref.value = null }
    }
